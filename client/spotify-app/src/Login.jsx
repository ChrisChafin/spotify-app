...
const Login = () => {
    const AUTH_URL = `https://accounts.spotify.com/authorize?client_id=${process.env.ea5965a4a1354c19b04d0df96c66f139}&response_type=code&redirect_uri=${process.env.localhost:3000}&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state`
